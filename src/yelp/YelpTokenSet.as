package yelp
{
	...
	public class YelpTokenSet extends Object
	{
		...
		public function YelpTokenSet(consumerKey:String,consumerKeySecret:String,oauthToken:String,oauthTokenSecret:String)
		{
